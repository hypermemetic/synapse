...
```yaml
---
# Template for: symbols-dyn arbor tree-list
...
symbols-dyn --schema arbor tree-list
...
symbols-dyn --template ./my-template.hbs arbor tree-list

# Pretty JSON (no template)
symbols-dyn --pretty arbor tree-list
```
