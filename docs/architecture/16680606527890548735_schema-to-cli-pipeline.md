...
The symbols-dyn CLI is **dynamically generated** from schemas provided by the Plexus server. This document explains:
...
└─────────────────────────────────────────────────────────────────────┘
          ...
          │
          ↓
    User input:  symbols-dyn arbor tree-create --tree-id abc-123
          │
          ↓
    CommandInvocation
...
```bash
symbols-dyn bash execute "echo hello"  # Instead of --command "echo hello"
```
