...
│  2. substrate.schema      →  Get activation list + method names                │
│  3. substrate.full_schema →  Get params/returns JSON Schema per activation     │
│                                                                              │
...
-- Top-level schema from substrate.schema
...
-- Full schema from substrate.full_schema (includes JSON Schema)
