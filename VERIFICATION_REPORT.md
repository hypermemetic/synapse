...
1. `/Users/shmendez/dev/controlflow/hypermemetic/synapse/src/Synapse/IR/Builder.hs`
   - Removed hardcoded "1.0" version strings (2 locations)
   - Removed debug traces after verification

2. `/Users/shmendez/dev/controlflow/hypermemetic/synapse/test/IRSpec.hs`
...
3. `/Users/shmendez/dev/controlflow/hypermemetic/synapse/hub-synapse.cabal`
   - Added aeson, aeson-pretty, and bytestring to test dependencies
   - Added new test-suite: typeref-json

4. `/Users/shmendez/dev/controlflow/hypermemetic/synapse/test/TypeRefJson.hs` (NEW)
